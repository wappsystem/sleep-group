(function(){
    ...
    var modules={
        ...
        "paid-active-data":  			{url:"$H/m/paid-active-data.html",Table:"paid-wappsystem",form_module:"paid-form",tags:"marketing"},
        ...
        "charged-active-data":    			    {url:"$H/m/charged-active-data.html",Table:"charged-wappsystem",form_module:"charged-form"},
